function [vPhase,vLine,iLine,iPhase,perPhasePower,totalPower,lineLossPower,perPhasePf,totalPf,reqd_value,reqd_type,pfType]...
    = wye_delta(voltageSource, phaseImpedance, transmissionlineImpedance, sourceFreq, desiredPf, desiredType)
vLine=lineVoltage1(voltageSource);
iLine= lineCurrent2(voltageSource, phaseImpedance, transmissionlineImpedance);
iPhase= phaseCurrent2(voltageSource, phaseImpedance, transmissionlineImpedance);
