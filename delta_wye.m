function [vPhase,vLine,iLine,iPhase,perPhasePower,totalPower,lineLossPower,perPhasePf,totalPf,reqd_value,reqd_type, pfType]...
    = delta_wye(voltageSource, phaseImpedance, transmissionlineImpedance, sourceFreq, desiredPf, desiredType)
vLine=voltageSource;
iLine= lineCurrent3(voltageSource, phaseImpedance, transmissionlineImpedance);
iPhase= iLine;
